...
## 7. Recommandation pratique pour le projet

Pour ton projet, la meilleure option est de livrer :

1. un glossaire synthetique en tableau pour le jury ;
2. une version plus detaillee pour les indicateurs centraux ;
3. une distinction nette entre donnees sources et champs calcules du pipeline ;
4. une mention explicite de la limite WASH 2016 ;
5. une colonne "relation a la vulnerabilite" pour relier les indicateurs au raisonnement DWFA.

## 8. Positionnement final conseille

Si tu veux un message simple a porter en soutenance, je te recommande cette formulation :

> Le projet combine des donnees demographiques, sanitaires, d'acces a l'eau et de gouvernance pour identifier les pays prioritaires selon trois logiques d'action : creation de services, modernisation des services et accompagnement de la gouvernance publique. Dans cette lecture, la mortalite WASH joue le role de signal sanitaire de reference, tandis que l'acces a l'eau et la stabilite politique structurent la lecture decisionnelle.
